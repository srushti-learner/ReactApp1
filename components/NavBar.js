  ...
  return (<NavBar>
    <div className={menuIcon ? "navbar active":"navbar"}>
        <ul className='navbar-lists'>
            ...
            <li>
            <NavLink to='/contact' className="navbar-link " onClick={()=>setMenuIcon(false)}>Contact Us</NavLink>
            </li>
            <li>
            <NavLink to='/cart' className="navbar-link " onClick={()=>setMenuIcon(false)}>
                <FiShoppingCart className="cart-trolley"/>
            </NavLink>
            </li>
        </ul>
        <div className='mobile-navbar-btn'>
            <CgMenu name="menu-outline" className="mobile-nav-icon" onClick={()=>setMenuIcon(true)}></CgMenu>
